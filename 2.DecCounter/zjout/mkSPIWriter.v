...
module mkSPIWriter(CLK,
  ...
  wire WILL_FIRE_RL_spiFsm_action_l30c13,
  ...
  // rule RL_spiFsm_action_l32c13
  assign WILL_FIRE_RL_spiFsm_action_l32c13 =
	     !cnt[31] &&
	     (spiFsm_state_mkFSMstate == 4'd1 ||
	      spiFsm_state_mkFSMstate == 4'd3) ;

  // rule RL_spiFsm_action_l41c15
  assign WILL_FIRE_RL_spiFsm_action_l41c15 =
	     cnt[31] &&
	     (spiFsm_state_mkFSMstate == 4'd1 ||
	      spiFsm_state_mkFSMstate == 4'd3) ;
  ...
  // register mosi
  assign mosi$D_IN =
	     !WILL_FIRE_RL_spiFsm_action_l32c13 || MUX_mosi$write_1__VAL_1 ;
  assign mosi$EN =
	     WILL_FIRE_RL_spiFsm_action_l32c13 ||
	     WILL_FIRE_RL_spiFsm_action_l41c15 ;

  // register sck
  assign sck$D_IN = !WILL_FIRE_RL_spiFsm_action_l32c13 ;
  assign sck$EN =
	     WILL_FIRE_RL_spiFsm_action_l32c13 ||
	     spiFsm_state_mkFSMstate == 4'd2 ;
  ...
  always@(WILL_FIRE_RL_spiFsm_idle_l29c7 or
	  ...
	  WILL_FIRE_RL_spiFsm_action_l32c13 or
	  spiFsm_state_mkFSMstate or WILL_FIRE_RL_spiFsm_action_l41c15)
  begin
    case (1'b1) // synopsys parallel_case
      WILL_FIRE_RL_spiFsm_idle_l29c7: spiFsm_state_mkFSMstate$D_IN = 4'd0;
      WILL_FIRE_RL_spiFsm_action_l30c13: spiFsm_state_mkFSMstate$D_IN = 4'd1;
      WILL_FIRE_RL_spiFsm_action_l32c13: spiFsm_state_mkFSMstate$D_IN = 4'd2;
      spiFsm_state_mkFSMstate == 4'd2: spiFsm_state_mkFSMstate$D_IN = 4'd3;
      WILL_FIRE_RL_spiFsm_action_l41c15: spiFsm_state_mkFSMstate$D_IN = 4'd4;
  ...
  // register ss
  assign ss$D_IN = !WILL_FIRE_RL_spiFsm_action_l30c13 ;
  assign ss$EN =
	     WILL_FIRE_RL_spiFsm_action_l30c13 ||
	     spiFsm_state_mkFSMstate == 4'd4 ;
  ...
  begin
    ...
    $display("");
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_spiFsm_action_l32c13 &&
	  (spiFsm_state_mkFSMstate == 4'd2 ||
	   WILL_FIRE_RL_spiFsm_action_l41c15 ||
	   spiFsm_state_mkFSMstate == 4'd4 ||
	   spiFsm_state_mkFSMstate == 4'd5))
