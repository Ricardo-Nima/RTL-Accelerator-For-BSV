...
void MOD_mkDecCounter::RL_write_spi()
{
  ...
  DEF_cnt__h307 = INST_cnt.METH_read();
  DEF_temp__h169 = (tUInt8)((tUInt8)255u & DEF_cnt__h307);
...
void MOD_mkDecCounter::RL_run_counter()
{
  ...
  DEF_cnt__h307 = INST_cnt.METH_read();
  DEF_IF_cnt_EQ_4294967295_THEN_0_ELSE_cnt_PLUS_1___d8 = DEF_cnt__h307 == 4294967295u ? 0u : DEF_cnt__h307 + 1u;
...
tUInt8 MOD_mkDecCounter::METH_overflow()
{
  ...
  DEF_cnt__h307 = INST_cnt.METH_read();
  PORT_overflow = DEF_cnt__h307 == 4294967295u;
...
unsigned int MOD_mkDecCounter::dump_VCD_defs(unsigned int levels)
{
  ...
  vcd_write_def(sim_hdl, num++, "cnt__h307", 32u);
  vcd_set_clock(sim_hdl, num, __clk_handle_0);
...
void MOD_mkDecCounter::vcd_defs(tVCDDumpType dt, MOD_mkDecCounter &backing)
{
  ...
  if (dt == VCD_DUMP_XS)
  {
	...
	backing.PORT_RST_N = PORT_RST_N;
      ...
      ++num;
      if ((backing.DEF_cnt__h307) != DEF_cnt__h307)
      {
	vcd_write_val(sim_hdl, num, DEF_cnt__h307, 32u);
	backing.DEF_cnt__h307 = DEF_cnt__h307;
      }
      ++num;
