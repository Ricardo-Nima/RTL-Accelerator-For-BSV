...
class MOD_mkSPIWriter : public Module {
	...
	void generate_testbench(uint64_t sim_time, std::string cur_hierachy) {
		...
		for (auto& x : inchange_write_data._list) {
			if (x.at >= 10) {
				...
				int offset = is_first == false && is_second ? -10 : 0;
				is_second = is_first == true ? true : false;
				is_first = false;
				out_post += "\t#" + std::to_string(temp + offset) + " " + "EN_write" + " = " + "1" + ";\n";
 ...
 public:
  tUInt8 DEF_WILL_FIRE_RL_spiFsm_action_l43c14;
  tUInt8 DEF_WILL_FIRE_RL_spiFsm_action_l42c13;
  tUInt8 DEF_WILL_FIRE_RL_spiFsm_action_l41c15;
  tUInt8 DEF_WILL_FIRE_RL_spiFsm_action_l36c13;
  tUInt8 DEF_WILL_FIRE_RL_spiFsm_action_l32c13;
  tUInt8 DEF_WILL_FIRE_RL_spiFsm_action_l30c13;
  tUInt8 DEF_spiFsm_abort_whas_AND_spiFsm_abort_wget_OR_spi_ETC___d60;
  tUInt32 DEF_x__h16071;
  tUInt8 DEF_spiFsm_state_mkFSMstate_read____d31;
  tUInt8 DEF_spiFsm_state_fired__h15163;
  tUInt8 DEF_spiFsm_abort_whas____d4;
  tUInt8 DEF_spiFsm_abort_wget____d5;
  tUInt8 DEF_spiFsm_start_reg_1__h15161;
  tUInt8 DEF_spiFsm_start_reg__h17356;
 ...
 public:
  ...
  void RL_spiFsm_action_l30c13();
  void RL_spiFsm_action_l32c13();
  void RL_spiFsm_action_l36c13();
  void RL_spiFsm_action_l41c15();
  void RL_spiFsm_action_l42c13();
  void RL_spiFsm_action_l43c14();
  void RL_spiFsm_idle_l29c7();
