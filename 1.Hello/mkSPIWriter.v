...
module mkSPIWriter(CLK,
  ...
  wire WILL_FIRE_RL_spiFsm_action_l28c13,
       WILL_FIRE_RL_spiFsm_action_l30c13,
       WILL_FIRE_RL_spiFsm_action_l39c15,
       WILL_FIRE_RL_spiFsm_fsm_start,
       WILL_FIRE_RL_spiFsm_idle_l27c7;
  ...
  // rule RL_spiFsm_action_l30c13
  assign WILL_FIRE_RL_spiFsm_action_l30c13 =
	     !cnt[31] &&
	     (spiFsm_state_mkFSMstate == 4'd1 ||
	      spiFsm_state_mkFSMstate == 4'd3) ;

  // rule RL_spiFsm_action_l39c15
  assign WILL_FIRE_RL_spiFsm_action_l39c15 =
	     cnt[31] &&
	     (spiFsm_state_mkFSMstate == 4'd1 ||
	      spiFsm_state_mkFSMstate == 4'd3) ;
  ...
  // rule RL_spiFsm_idle_l27c7
  assign WILL_FIRE_RL_spiFsm_idle_l27c7 =
  ...
  // register mosi
  assign mosi$D_IN =
	     !WILL_FIRE_RL_spiFsm_action_l30c13 || MUX_mosi$write_1__VAL_1 ;
  assign mosi$EN =
	     WILL_FIRE_RL_spiFsm_action_l30c13 ||
	     WILL_FIRE_RL_spiFsm_action_l39c15 ;

  // register sck
  assign sck$D_IN = !WILL_FIRE_RL_spiFsm_action_l30c13 ;
  assign sck$EN =
	     WILL_FIRE_RL_spiFsm_action_l30c13 ||
	     spiFsm_state_mkFSMstate == 4'd2 ;
  ...
  // register spiFsm_state_mkFSMstate
  always@(WILL_FIRE_RL_spiFsm_idle_l27c7 or
	  WILL_FIRE_RL_spiFsm_action_l28c13 or
	  WILL_FIRE_RL_spiFsm_action_l30c13 or
	  spiFsm_state_mkFSMstate or WILL_FIRE_RL_spiFsm_action_l39c15)
  begin
    case (1'b1) // synopsys parallel_case
      WILL_FIRE_RL_spiFsm_idle_l27c7: spiFsm_state_mkFSMstate$D_IN = 4'd0;
      WILL_FIRE_RL_spiFsm_action_l28c13: spiFsm_state_mkFSMstate$D_IN = 4'd1;
      WILL_FIRE_RL_spiFsm_action_l30c13: spiFsm_state_mkFSMstate$D_IN = 4'd2;
      spiFsm_state_mkFSMstate == 4'd2: spiFsm_state_mkFSMstate$D_IN = 4'd3;
      WILL_FIRE_RL_spiFsm_action_l39c15: spiFsm_state_mkFSMstate$D_IN = 4'd4;
  ...
  // register ss
  assign ss$D_IN = !WILL_FIRE_RL_spiFsm_action_l28c13 ;
  assign ss$EN =
	     WILL_FIRE_RL_spiFsm_action_l28c13 ||
	     spiFsm_state_mkFSMstate == 4'd4 ;
  ...
  begin
    #0;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_spiFsm_action_l30c13 &&
	  (spiFsm_state_mkFSMstate == 4'd2 ||
	   WILL_FIRE_RL_spiFsm_action_l39c15 ||
	   spiFsm_state_mkFSMstate == 4'd4 ||
	   spiFsm_state_mkFSMstate == 4'd5))
	$display("Error: \"Hello.bsv\", line 30, column 13: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_spiFsm_action_l30c13] and\n  [RL_spiFsm_action_l34c13, RL_spiFsm_action_l39c15, RL_spiFsm_action_l40c13,\n  RL_spiFsm_action_l41c14] ) fired in the same clock cycle.\n");
    if (RST_N != `BSV_RESET_VALUE)
      if (spiFsm_state_mkFSMstate == 4'd2 &&
	  (WILL_FIRE_RL_spiFsm_action_l39c15 ||
	   spiFsm_state_mkFSMstate == 4'd4 ||
	   spiFsm_state_mkFSMstate == 4'd5))
	$display("Error: \"Hello.bsv\", line 34, column 13: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_spiFsm_action_l34c13] and\n  [RL_spiFsm_action_l39c15, RL_spiFsm_action_l40c13, RL_spiFsm_action_l41c14]\n  ) fired in the same clock cycle.\n");
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_spiFsm_action_l39c15 &&
	  (spiFsm_state_mkFSMstate == 4'd4 ||
	   spiFsm_state_mkFSMstate == 4'd5))
	$display("Error: \"Hello.bsv\", line 39, column 15: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_spiFsm_action_l39c15] and\n  [RL_spiFsm_action_l40c13, RL_spiFsm_action_l41c14] ) fired in the same clock\n  cycle.\n");
    if (RST_N != `BSV_RESET_VALUE)
      if (spiFsm_state_mkFSMstate == 4'd4 && spiFsm_state_mkFSMstate == 4'd5)
	$display("Error: \"Hello.bsv\", line 40, column 13: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_spiFsm_action_l40c13] and\n  [RL_spiFsm_action_l41c14] ) fired in the same clock cycle.\n");
    if (RST_N != `BSV_RESET_VALUE)
