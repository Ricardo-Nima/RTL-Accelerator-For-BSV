...
static std::string const __str_literal_2("Error: \"Hello.bsv\", line 26, column 13: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_spiFsm_action_l26c13] and\n  [RL_spiFsm_action_l28c13, RL_spiFsm_action_l32c13, RL_spiFsm_action_l37c15,\n  RL_spiFsm_action_l38c13, RL_spiFsm_action_l39c14] ) fired in the same clock\n  cycle.\n",
					 288u);
static std::string const __str_literal_3("Error: \"Hello.bsv\", line 28, column 13: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_spiFsm_action_l28c13] and\n  [RL_spiFsm_action_l32c13, RL_spiFsm_action_l37c15, RL_spiFsm_action_l38c13,\n  RL_spiFsm_action_l39c14] ) fired in the same clock cycle.\n",
					 261u);
static std::string const __str_literal_4("Error: \"Hello.bsv\", line 32, column 13: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_spiFsm_action_l32c13] and\n  [RL_spiFsm_action_l37c15, RL_spiFsm_action_l38c13, RL_spiFsm_action_l39c14]\n  ) fired in the same clock cycle.\n",
					 236u);
static std::string const __str_literal_5("Error: \"Hello.bsv\", line 37, column 15: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_spiFsm_action_l37c15] and\n  [RL_spiFsm_action_l38c13, RL_spiFsm_action_l39c14] ) fired in the same clock\n  cycle.\n",
					 211u);
static std::string const __str_literal_6("Error: \"Hello.bsv\", line 38, column 13: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_spiFsm_action_l38c13] and\n  [RL_spiFsm_action_l39c14] ) fired in the same clock cycle.\n",
					 184u);
...
void MOD_mkSPIWriter::init_symbols_0()
{
  ...
  init_symbol(&symbols[9u], "RL_spiFsm_action_l26c13", SYM_RULE);
  init_symbol(&symbols[10u], "RL_spiFsm_action_l28c13", SYM_RULE);
  init_symbol(&symbols[11u], "RL_spiFsm_action_l32c13", SYM_RULE);
  init_symbol(&symbols[12u], "RL_spiFsm_action_l37c15", SYM_RULE);
  init_symbol(&symbols[13u], "RL_spiFsm_action_l38c13", SYM_RULE);
  init_symbol(&symbols[14u], "RL_spiFsm_action_l39c14", SYM_RULE);
  init_symbol(&symbols[15u], "RL_spiFsm_fsm_start", SYM_RULE);
  init_symbol(&symbols[16u], "RL_spiFsm_idle_l25c7", SYM_RULE);
  ...
  init_symbol(&symbols[26u],
	      "spiFsm_start_reg_1__h15142",
	      SYM_DEF,
	      &DEF_spiFsm_start_reg_1__h15142,
	      1u);
  init_symbol(&symbols[27u], "spiFsm_start_reg_2", SYM_MODULE, &INST_spiFsm_start_reg_2);
  init_symbol(&symbols[28u], "spiFsm_start_reg__h17313", SYM_DEF, &DEF_spiFsm_start_reg__h17313, 1u);
  ...
  init_symbol(&symbols[33u],
	      "spiFsm_state_fired__h15144",
	      SYM_DEF,
	      &DEF_spiFsm_state_fired__h15144,
	      1u);
  ...
  init_symbol(&symbols[38u],
	      "WILL_FIRE_RL_spiFsm_action_l26c13",
	      SYM_DEF,
	      &DEF_WILL_FIRE_RL_spiFsm_action_l26c13,
	      1u);
  init_symbol(&symbols[39u],
	      "WILL_FIRE_RL_spiFsm_action_l28c13",
	      SYM_DEF,
	      &DEF_WILL_FIRE_RL_spiFsm_action_l28c13,
	      1u);
  ...
  init_symbol(&symbols[41u],
	      "WILL_FIRE_RL_spiFsm_action_l37c15",
	      SYM_DEF,
	      &DEF_WILL_FIRE_RL_spiFsm_action_l37c15,
	      1u);
  init_symbol(&symbols[42u],
	      "WILL_FIRE_RL_spiFsm_action_l38c13",
	      SYM_DEF,
	      &DEF_WILL_FIRE_RL_spiFsm_action_l38c13,
	      1u);
  init_symbol(&symbols[43u],
	      "WILL_FIRE_RL_spiFsm_action_l39c14",
	      SYM_DEF,
	      &DEF_WILL_FIRE_RL_spiFsm_action_l39c14,
	      1u);
  init_symbol(&symbols[44u], "wdata", SYM_MODULE, &INST_wdata);
  init_symbol(&symbols[45u], "x__h16042", SYM_DEF, &DEF_x__h16042, 32u);
}
...
void MOD_mkSPIWriter::RL_spiFsm_state_every()
{
  ...
  tUInt8 DEF_spiFsm_state_can_overlap__h2655;
  DEF_spiFsm_state_can_overlap__h2655 = INST_spiFsm_state_can_overlap.METH_read();
  DEF_spiFsm_state_set_pw_whas__6_OR_NOT_spiFsm_stat_ETC___d21 = INST_spiFsm_state_set_pw.METH_whas() || (!INST_spiFsm_state_overlap_pw.METH_whas() && DEF_spiFsm_state_can_overlap__h2655);
...
void MOD_mkSPIWriter::RL_spiFsm_action_l26c13()
{
...
void MOD_mkSPIWriter::RL_spiFsm_action_l28c13()
{
  tUInt8 DEF_x__h16006;
  tUInt8 DEF_cnt_7_BITS_2_TO_0___d46;
  tUInt8 DEF_bs__h16012;
  DEF_x__h16042 = INST_cnt.METH_read();
  DEF_bs__h16012 = INST_wdata.METH_read();
  DEF_cnt_7_BITS_2_TO_0___d46 = (tUInt8)((tUInt8)7u & DEF_x__h16042);
  DEF_x__h16006 = primExtract8(1u,
			       8u,
			       (tUInt8)(DEF_bs__h16012),
			       3u,
			       (tUInt8)(DEF_cnt_7_BITS_2_TO_0___d46),
  ...
  INST_mosi.METH_write(DEF_x__h16006);
}
...
void MOD_mkSPIWriter::RL_spiFsm_action_l32c13()
{
  ...
  DEF_x__h16042 = INST_cnt.METH_read();
  DEF_cnt_7_MINUS_1___d50 = DEF_x__h16042 - 1u;
...
void MOD_mkSPIWriter::RL_spiFsm_action_l37c15()
{
...
void MOD_mkSPIWriter::RL_spiFsm_action_l38c13()
{
...
void MOD_mkSPIWriter::RL_spiFsm_action_l39c14()
{
...
void MOD_mkSPIWriter::RL_spiFsm_idle_l25c7()
{
  INST_spiFsm_state_mkFSMstate.METH_write((tUInt8)0u);
  INST_spiFsm_state_fired_1.METH_wset((tUInt8)1u);
  INST_spiFsm_state_set_pw.METH_wset();
...
void MOD_mkSPIWriter::__me_check_5()
{
  if (!(PORT_RST_N == (tUInt8)0u))
    if (DEF_WILL_FIRE_RL_spiFsm_action_l26c13 && ((((DEF_WILL_FIRE_RL_spiFsm_action_l28c13 || DEF_WILL_FIRE_RL_spiFsm_action_l32c13) || DEF_WILL_FIRE_RL_spiFsm_action_l37c15) || DEF_WILL_FIRE_RL_spiFsm_action_l38c13) || DEF_WILL_FIRE_RL_spiFsm_action_l39c14))
...
{
  if (!(PORT_RST_N == (tUInt8)0u))
    if (DEF_WILL_FIRE_RL_spiFsm_action_l28c13 && (((DEF_WILL_FIRE_RL_spiFsm_action_l32c13 || DEF_WILL_FIRE_RL_spiFsm_action_l37c15) || DEF_WILL_FIRE_RL_spiFsm_action_l38c13) || DEF_WILL_FIRE_RL_spiFsm_action_l39c14))
...
{
  if (!(PORT_RST_N == (tUInt8)0u))
    if (DEF_WILL_FIRE_RL_spiFsm_action_l32c13 && ((DEF_WILL_FIRE_RL_spiFsm_action_l37c15 || DEF_WILL_FIRE_RL_spiFsm_action_l38c13) || DEF_WILL_FIRE_RL_spiFsm_action_l39c14))
...
{
  if (!(PORT_RST_N == (tUInt8)0u))
    if (DEF_WILL_FIRE_RL_spiFsm_action_l37c15 && (DEF_WILL_FIRE_RL_spiFsm_action_l38c13 || DEF_WILL_FIRE_RL_spiFsm_action_l39c14))
...
{
  if (!(PORT_RST_N == (tUInt8)0u))
    if (DEF_WILL_FIRE_RL_spiFsm_action_l38c13 && DEF_WILL_FIRE_RL_spiFsm_action_l39c14)
...
tUInt8 MOD_mkSPIWriter::METH_RDY_write()
{
  ...
  DEF_spiFsm_state_fired__h15144 = INST_spiFsm_state_fired.METH_read();
  DEF_spiFsm_abort_whas____d4 = INST_spiFsm_abort.METH_whas();
  DEF_spiFsm_abort_wget____d5 = INST_spiFsm_abort.METH_wget();
  DEF_spiFsm_start_reg_1__h15142 = INST_spiFsm_start_reg_1.METH_read();
  DEF_spiFsm_start_reg__h17313 = INST_spiFsm_start_reg.METH_read();
  ...
  DEF_spiFsm_abort_whas_AND_spiFsm_abort_wget_OR_spi_ETC___d60 = DEF_spiFsm_abort_whas_AND_spiFsm_abort_wget_OR_spi_ETC___d35 && (!DEF_spiFsm_start_reg_1__h15142 || DEF_spiFsm_state_fired__h15144);
  DEF_CAN_FIRE_write = DEF_spiFsm_abort_whas_AND_spiFsm_abort_wget_OR_spi_ETC___d60 && !DEF_spiFsm_start_reg__h17313;
...
unsigned int MOD_mkSPIWriter::dump_VCD_defs(unsigned int levels)
{
  ...
  vcd_write_def(sim_hdl, num++, "WILL_FIRE_RL_spiFsm_action_l26c13", 1u);
  vcd_set_clock(sim_hdl, num, __clk_handle_0);
  vcd_write_def(sim_hdl, num++, "WILL_FIRE_RL_spiFsm_action_l28c13", 1u);
  vcd_set_clock(sim_hdl, num, __clk_handle_0);
  vcd_write_def(sim_hdl, num++, "WILL_FIRE_RL_spiFsm_action_l32c13", 1u);
  vcd_set_clock(sim_hdl, num, __clk_handle_0);
  vcd_write_def(sim_hdl, num++, "WILL_FIRE_RL_spiFsm_action_l37c15", 1u);
  vcd_set_clock(sim_hdl, num, __clk_handle_0);
  vcd_write_def(sim_hdl, num++, "WILL_FIRE_RL_spiFsm_action_l38c13", 1u);
  vcd_set_clock(sim_hdl, num, __clk_handle_0);
  vcd_write_def(sim_hdl, num++, "WILL_FIRE_RL_spiFsm_action_l39c14", 1u);
  vcd_set_clock(sim_hdl, num, __clk_handle_0);
  ...
  vcd_set_clock(sim_hdl, num, __clk_handle_0);
  vcd_write_def(sim_hdl, num++, "spiFsm_start_reg_1__h15142", 1u);
  vcd_set_clock(sim_hdl, num, __clk_handle_0);
  vcd_write_def(sim_hdl, num++, "spiFsm_start_reg__h17313", 1u);
  vcd_set_clock(sim_hdl, num, __clk_handle_0);
  vcd_write_def(sim_hdl, num++, "spiFsm_state_fired__h15144", 1u);
  vcd_set_clock(sim_hdl, num, __clk_handle_0);
...
void MOD_mkSPIWriter::vcd_defs(tVCDDumpType dt, MOD_mkSPIWriter &backing)
{
  ...
  if (dt == VCD_DUMP_XS)
  {
	...
	backing.PORT_RST_N = PORT_RST_N;
      ...
      ++num;
      if ((backing.DEF_WILL_FIRE_RL_spiFsm_action_l26c13) != DEF_WILL_FIRE_RL_spiFsm_action_l26c13)
      {
	vcd_write_val(sim_hdl, num, DEF_WILL_FIRE_RL_spiFsm_action_l26c13, 1u);
	backing.DEF_WILL_FIRE_RL_spiFsm_action_l26c13 = DEF_WILL_FIRE_RL_spiFsm_action_l26c13;
      }
      ++num;
      if ((backing.DEF_WILL_FIRE_RL_spiFsm_action_l28c13) != DEF_WILL_FIRE_RL_spiFsm_action_l28c13)
      {
	vcd_write_val(sim_hdl, num, DEF_WILL_FIRE_RL_spiFsm_action_l28c13, 1u);
	backing.DEF_WILL_FIRE_RL_spiFsm_action_l28c13 = DEF_WILL_FIRE_RL_spiFsm_action_l28c13;
      }
      ++num;
	...
	backing.DEF_WILL_FIRE_RL_spiFsm_action_l32c13 = DEF_WILL_FIRE_RL_spiFsm_action_l32c13;
      ...
      ++num;
      if ((backing.DEF_WILL_FIRE_RL_spiFsm_action_l37c15) != DEF_WILL_FIRE_RL_spiFsm_action_l37c15)
      {
	vcd_write_val(sim_hdl, num, DEF_WILL_FIRE_RL_spiFsm_action_l37c15, 1u);
	backing.DEF_WILL_FIRE_RL_spiFsm_action_l37c15 = DEF_WILL_FIRE_RL_spiFsm_action_l37c15;
      }
      ++num;
      if ((backing.DEF_WILL_FIRE_RL_spiFsm_action_l38c13) != DEF_WILL_FIRE_RL_spiFsm_action_l38c13)
      {
	vcd_write_val(sim_hdl, num, DEF_WILL_FIRE_RL_spiFsm_action_l38c13, 1u);
	backing.DEF_WILL_FIRE_RL_spiFsm_action_l38c13 = DEF_WILL_FIRE_RL_spiFsm_action_l38c13;
      }
      ++num;
      if ((backing.DEF_WILL_FIRE_RL_spiFsm_action_l39c14) != DEF_WILL_FIRE_RL_spiFsm_action_l39c14)
      {
	vcd_write_val(sim_hdl, num, DEF_WILL_FIRE_RL_spiFsm_action_l39c14, 1u);
	backing.DEF_WILL_FIRE_RL_spiFsm_action_l39c14 = DEF_WILL_FIRE_RL_spiFsm_action_l39c14;
      }
      ++num;
	...
	backing.DEF_spiFsm_abort_whas____d4 = DEF_spiFsm_abort_whas____d4;
      ...
      ++num;
      if ((backing.DEF_spiFsm_start_reg_1__h15142) != DEF_spiFsm_start_reg_1__h15142)
      {
	vcd_write_val(sim_hdl, num, DEF_spiFsm_start_reg_1__h15142, 1u);
	backing.DEF_spiFsm_start_reg_1__h15142 = DEF_spiFsm_start_reg_1__h15142;
      }
      ++num;
      if ((backing.DEF_spiFsm_start_reg__h17313) != DEF_spiFsm_start_reg__h17313)
      {
	vcd_write_val(sim_hdl, num, DEF_spiFsm_start_reg__h17313, 1u);
	backing.DEF_spiFsm_start_reg__h17313 = DEF_spiFsm_start_reg__h17313;
      }
      ++num;
      if ((backing.DEF_spiFsm_state_fired__h15144) != DEF_spiFsm_state_fired__h15144)
      {
	vcd_write_val(sim_hdl, num, DEF_spiFsm_state_fired__h15144, 1u);
	backing.DEF_spiFsm_state_fired__h15144 = DEF_spiFsm_state_fired__h15144;
      }
      ++num;
