...
static void schedule_posedge_CLK(tSimStateHdl simHdl, void *instance_ptr)
	 ...
	 tUInt8 DEF_INST_top_INST_spi_writer_DEF_cnt_BIT_31___h6361;
	 ...
	 tUInt8 DEF_INST_top_INST_spi_writer_DEF_CAN_FIRE_RL_spiFsm_action_l25c13;
	 tUInt8 DEF_INST_top_INST_spi_writer_DEF_CAN_FIRE_RL_spiFsm_action_l27c13;
	 tUInt8 DEF_INST_top_INST_spi_writer_DEF_CAN_FIRE_RL_spiFsm_action_l31c13;
	 tUInt8 DEF_INST_top_INST_spi_writer_DEF_CAN_FIRE_RL_spiFsm_action_l36c15;
	 tUInt8 DEF_INST_top_INST_spi_writer_DEF_CAN_FIRE_RL_spiFsm_action_l37c13;
	 tUInt8 DEF_INST_top_INST_spi_writer_DEF_CAN_FIRE_RL_spiFsm_action_l38c14;
	 tUInt8 DEF_INST_top_INST_spi_writer_DEF_CAN_FIRE_RL_spiFsm_idle_l24c7;
	 tUInt8 DEF_INST_top_INST_spi_writer_DEF_WILL_FIRE_RL_spiFsm_idle_l24c7;
	 ...
	 tUInt8 DEF_INST_top_DEF_CAN_FIRE_RL_action_l15c20;
	 tUInt8 DEF_INST_top_DEF_CAN_FIRE_RL_action_l16c20;
	 tUInt8 DEF_INST_top_DEF_CAN_FIRE_RL_action_l17c20;
	 tUInt8 DEF_INST_top_DEF_CAN_FIRE_RL_idle_l14c7;
	 tUInt8 DEF_INST_top_DEF_WILL_FIRE_RL_idle_l14c7;
	 ...
	 DEF_INST_top_DEF_CAN_FIRE_RL_action_l16c20 = DEF_INST_top_DEF_spi_writer_RDY_write____d30 && (DEF_INST_top_DEF_NOT_abort_whas_6_OR_NOT_abort_wget_7___d28 && DEF_INST_top_DEF_state_mkFSMstate_read____d32 == (tUInt8)1u);
	 INST_top.DEF_WILL_FIRE_RL_action_l16c20 = DEF_INST_top_DEF_CAN_FIRE_RL_action_l16c20;
	 DEF_INST_top_DEF_CAN_FIRE_RL_action_l17c20 = DEF_INST_top_DEF_spi_writer_RDY_write____d30 && (DEF_INST_top_DEF_NOT_abort_whas_6_OR_NOT_abort_wget_7___d28 && DEF_INST_top_DEF_state_mkFSMstate_read____d32 == (tUInt8)2u);
	 INST_top.DEF_WILL_FIRE_RL_action_l17c20 = DEF_INST_top_DEF_CAN_FIRE_RL_action_l17c20;
	 ...
	 INST_top.INST_spi_writer.DEF_x__h16008 = INST_top.INST_spi_writer.INST_cnt.METH_read();
	 ...
	 DEF_INST_top_INST_spi_writer_DEF_cnt_BIT_31___h6361 = (tUInt8)((INST_top.INST_spi_writer.DEF_x__h16008) >> 31u);
	 ...
	 DEF_INST_top_INST_spi_writer_DEF_CAN_FIRE_RL_spiFsm_action_l27c13 = !DEF_INST_top_INST_spi_writer_DEF_cnt_BIT_31___h6361 && DEF_INST_top_INST_spi_writer_DEF_NOT_spiFsm_abort_whas_6_OR_NOT_spiFsm_abort_wg_ETC___d43;
	 INST_top.INST_spi_writer.DEF_WILL_FIRE_RL_spiFsm_action_l27c13 = DEF_INST_top_INST_spi_writer_DEF_CAN_FIRE_RL_spiFsm_action_l27c13;
	 DEF_INST_top_INST_spi_writer_DEF_CAN_FIRE_RL_spiFsm_action_l31c13 = DEF_INST_top_INST_spi_writer_DEF_NOT_spiFsm_abort_whas_6_OR_NOT_spiFsm_abort_wg_ETC___d28 && (INST_top.INST_spi_writer.DEF_spiFsm_state_mkFSMstate_read____d31) == (tUInt8)2u;
	 INST_top.INST_spi_writer.DEF_WILL_FIRE_RL_spiFsm_action_l31c13 = DEF_INST_top_INST_spi_writer_DEF_CAN_FIRE_RL_spiFsm_action_l31c13;
	 DEF_INST_top_INST_spi_writer_DEF_CAN_FIRE_RL_spiFsm_action_l36c15 = DEF_INST_top_INST_spi_writer_DEF_cnt_BIT_31___h6361 && DEF_INST_top_INST_spi_writer_DEF_NOT_spiFsm_abort_whas_6_OR_NOT_spiFsm_abort_wg_ETC___d43;
	 INST_top.INST_spi_writer.DEF_WILL_FIRE_RL_spiFsm_action_l36c15 = DEF_INST_top_INST_spi_writer_DEF_CAN_FIRE_RL_spiFsm_action_l36c15;
	 DEF_INST_top_INST_spi_writer_DEF_CAN_FIRE_RL_spiFsm_action_l37c13 = DEF_INST_top_INST_spi_writer_DEF_NOT_spiFsm_abort_whas_6_OR_NOT_spiFsm_abort_wg_ETC___d28 && (INST_top.INST_spi_writer.DEF_spiFsm_state_mkFSMstate_read____d31) == (tUInt8)4u;
	 INST_top.INST_spi_writer.DEF_WILL_FIRE_RL_spiFsm_action_l37c13 = DEF_INST_top_INST_spi_writer_DEF_CAN_FIRE_RL_spiFsm_action_l37c13;
	 DEF_INST_top_INST_spi_writer_DEF_CAN_FIRE_RL_spiFsm_action_l38c14 = DEF_INST_top_INST_spi_writer_DEF_NOT_spiFsm_abort_whas_6_OR_NOT_spiFsm_abort_wg_ETC___d28 && (INST_top.INST_spi_writer.DEF_spiFsm_state_mkFSMstate_read____d31) == (tUInt8)5u;
	 INST_top.INST_spi_writer.DEF_WILL_FIRE_RL_spiFsm_action_l38c14 = DEF_INST_top_INST_spi_writer_DEF_CAN_FIRE_RL_spiFsm_action_l38c14;
	 INST_top.INST_spi_writer.DEF_spiFsm_state_fired__h15110 = INST_top.INST_spi_writer.INST_spiFsm_state_fired.METH_read();
	 INST_top.INST_spi_writer.DEF_spiFsm_start_reg_1__h15108 = INST_top.INST_spi_writer.INST_spiFsm_start_reg_1.METH_read();
	 INST_top.INST_spi_writer.DEF_spiFsm_start_reg__h17279 = INST_top.INST_spi_writer.INST_spiFsm_start_reg.METH_read();
	 ...
	 INST_top.INST_spi_writer.DEF_spiFsm_abort_whas_AND_spiFsm_abort_wget_OR_spi_ETC___d60 = INST_top.INST_spi_writer.DEF_spiFsm_abort_whas_AND_spiFsm_abort_wget_OR_spi_ETC___d35 && (!(INST_top.INST_spi_writer.DEF_spiFsm_start_reg_1__h15108) || INST_top.INST_spi_writer.DEF_spiFsm_state_fired__h15110);
	 DEF_INST_top_INST_spi_writer_DEF_CAN_FIRE_RL_spiFsm_fsm_start = INST_top.INST_spi_writer.DEF_spiFsm_abort_whas_AND_spiFsm_abort_wget_OR_spi_ETC___d60 && INST_top.INST_spi_writer.DEF_spiFsm_start_reg__h17279;
	 ...
	 DEF_INST_top_INST_spi_writer_DEF_CAN_FIRE_RL_spiFsm_restart = (INST_top.INST_spi_writer.DEF_spiFsm_start_reg_1__h15108 && !(INST_top.INST_spi_writer.DEF_spiFsm_state_fired__h15110)) && DEF_INST_top_INST_spi_writer_DEF_NOT_spiFsm_abort_whas_6_OR_NOT_spiFsm_abort_wg_ETC___d28;
	 ...
	 DEF_INST_top_DEF_CAN_FIRE_RL_action_l15c20 = DEF_INST_top_DEF_spi_writer_RDY_write____d30 && ((DEF_INST_top_DEF_start_wire_whas____d7 && DEF_INST_top_DEF_start_wire_wget____d9) && DEF_INST_top_DEF_abort_whas_AND_abort_wget_OR_state_mkFSMstate__ETC___d36);
	 INST_top.DEF_WILL_FIRE_RL_action_l15c20 = DEF_INST_top_DEF_CAN_FIRE_RL_action_l15c20;
	 ...
	 DEF_INST_top_DEF_CAN_FIRE_RL_idle_l14c7 = DEF_INST_top_DEF_NOT_start_wire_whas_OR_NOT_start_wire_wget_0___d11 && (DEF_INST_top_DEF_NOT_abort_whas_6_OR_NOT_abort_wget_7___d28 && DEF_INST_top_DEF_state_mkFSMstate_read__2_EQ_3___d35);
	 DEF_INST_top_DEF_WILL_FIRE_RL_idle_l14c7 = DEF_INST_top_DEF_CAN_FIRE_RL_idle_l14c7;
	 DEF_INST_top_DEF_CAN_FIRE_RL_state_handle_abort = (DEF_INST_top_DEF_abort_whas_AND_abort_wget___d6 && DEF_INST_top_DEF_NOT_start_wire_whas_OR_NOT_start_wire_wget_0___d11) && !DEF_INST_top_DEF_CAN_FIRE_RL_restart;
	 DEF_INST_top_DEF_WILL_FIRE_RL_state_handle_abort = DEF_INST_top_DEF_CAN_FIRE_RL_state_handle_abort;
	 if (DEF_INST_top_DEF_WILL_FIRE_RL_idle_l14c7)
	   INST_top.RL_idle_l14c7();
	 if (DEF_INST_top_DEF_WILL_FIRE_RL_spi_show)
	   INST_top.RL_spi_show();
	 if (INST_top.DEF_WILL_FIRE_RL_action_l15c20)
	   INST_top.RL_action_l15c20();
	 if (INST_top.DEF_WILL_FIRE_RL_action_l16c20)
	   INST_top.RL_action_l16c20();
	 if (INST_top.DEF_WILL_FIRE_RL_action_l17c20)
	   INST_top.RL_action_l17c20();
	 ...
	 if (INST_top.INST_spi_writer.DEF_WILL_FIRE_RL_spiFsm_action_l27c13)
	   INST_top.INST_spi_writer.RL_spiFsm_action_l27c13();
	 ...
	 if (INST_top.INST_spi_writer.DEF_WILL_FIRE_RL_spiFsm_action_l31c13)
	   INST_top.INST_spi_writer.RL_spiFsm_action_l31c13();
	 if (INST_top.INST_spi_writer.DEF_WILL_FIRE_RL_spiFsm_action_l36c15)
	   INST_top.INST_spi_writer.RL_spiFsm_action_l36c15();
	 if (INST_top.INST_spi_writer.DEF_WILL_FIRE_RL_spiFsm_action_l37c13)
	   INST_top.INST_spi_writer.RL_spiFsm_action_l37c13();
	 if (INST_top.INST_spi_writer.DEF_WILL_FIRE_RL_spiFsm_action_l38c14)
	   INST_top.INST_spi_writer.RL_spiFsm_action_l38c14();
	 ...
	 DEF_INST_top_INST_spi_writer_DEF_CAN_FIRE_RL_spiFsm_action_l25c13 = ((DEF_INST_top_INST_spi_writer_DEF_spiFsm_start_wire_whas____d7 && DEF_INST_top_INST_spi_writer_DEF_spiFsm_start_wire_wget____d9) && INST_top.INST_spi_writer.DEF_spiFsm_abort_whas_AND_spiFsm_abort_wget_OR_spi_ETC___d35) && !(((DEF_INST_top_INST_spi_writer_DEF_CAN_FIRE_RL_spiFsm_action_l38c14 || DEF_INST_top_INST_spi_writer_DEF_CAN_FIRE_RL_spiFsm_action_l37c13) || (DEF_INST_top_INST_spi_writer_DEF_CAN_FIRE_RL_spiFsm_action_l36c15 || DEF_INST_top_INST_spi_writer_DEF_CAN_FIRE_RL_spiFsm_action_l31c13)) || DEF_INST_top_INST_spi_writer_DEF_CAN_FIRE_RL_spiFsm_action_l27c13);
	 INST_top.INST_spi_writer.DEF_WILL_FIRE_RL_spiFsm_action_l25c13 = DEF_INST_top_INST_spi_writer_DEF_CAN_FIRE_RL_spiFsm_action_l25c13;
	 ...
	 DEF_INST_top_INST_spi_writer_DEF_CAN_FIRE_RL_spiFsm_idle_l24c7 = (DEF_INST_top_INST_spi_writer_DEF_NOT_spiFsm_start_wire_whas_OR_NOT_spiFsm_start_ETC___d11 && (DEF_INST_top_INST_spi_writer_DEF_NOT_spiFsm_abort_whas_6_OR_NOT_spiFsm_abort_wg_ETC___d28 && INST_top.INST_spi_writer.DEF_spiFsm_state_mkFSMstate_read__1_EQ_6___d34)) && !(((DEF_INST_top_INST_spi_writer_DEF_CAN_FIRE_RL_spiFsm_action_l38c14 || DEF_INST_top_INST_spi_writer_DEF_CAN_FIRE_RL_spiFsm_action_l37c13) || (DEF_INST_top_INST_spi_writer_DEF_CAN_FIRE_RL_spiFsm_action_l36c15 || DEF_INST_top_INST_spi_writer_DEF_CAN_FIRE_RL_spiFsm_action_l31c13)) || DEF_INST_top_INST_spi_writer_DEF_CAN_FIRE_RL_spiFsm_action_l27c13);
	 DEF_INST_top_INST_spi_writer_DEF_WILL_FIRE_RL_spiFsm_idle_l24c7 = DEF_INST_top_INST_spi_writer_DEF_CAN_FIRE_RL_spiFsm_idle_l24c7;
	 DEF_INST_top_INST_spi_writer_DEF_CAN_FIRE_RL_spiFsm_state_handle_abort = (INST_top.INST_spi_writer.DEF_spiFsm_abort_whas_AND_spiFsm_abort_wget___d6 && DEF_INST_top_INST_spi_writer_DEF_NOT_spiFsm_start_wire_whas_OR_NOT_spiFsm_start_ETC___d11) && !(((DEF_INST_top_INST_spi_writer_DEF_CAN_FIRE_RL_spiFsm_action_l38c14 || DEF_INST_top_INST_spi_writer_DEF_CAN_FIRE_RL_spiFsm_action_l37c13) || (DEF_INST_top_INST_spi_writer_DEF_CAN_FIRE_RL_spiFsm_action_l36c15 || DEF_INST_top_INST_spi_writer_DEF_CAN_FIRE_RL_spiFsm_action_l31c13)) || (DEF_INST_top_INST_spi_writer_DEF_CAN_FIRE_RL_spiFsm_action_l27c13 || DEF_INST_top_INST_spi_writer_DEF_CAN_FIRE_RL_spiFsm_restart));
	 ...
	 if (INST_top.INST_spi_writer.DEF_WILL_FIRE_RL_spiFsm_action_l25c13)
	   INST_top.INST_spi_writer.RL_spiFsm_action_l25c13();
	 ...
	 if (DEF_INST_top_INST_spi_writer_DEF_WILL_FIRE_RL_spiFsm_idle_l24c7)
	   INST_top.INST_spi_writer.RL_spiFsm_idle_l24c7();
...
time_t MODEL_mkTb::get_creation_time()
{
  ...
  /* Wed Jan  4 09:43:00 UTC 2023 */
  return 1672825380llu;
}
