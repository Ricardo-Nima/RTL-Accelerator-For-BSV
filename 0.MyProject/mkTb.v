...
module mkTb(CLK,
  ...
  mkSPIWriter spi_writer(.CLK(CLK),
			 ...
			 .hook_write_data(spi_writer$hook_write_data),
			 .RDY_hook_write_data(),
			 .spi(spi_writer$spi));
  ...
  // rule RL_idle_l93c7
  assign WILL_FIRE_RL_idle_l93c7 =
	     !start_wire$whas && state_mkFSMstate == 3'd3 ;

  // rule RL_action_l94c20
  assign WILL_FIRE_RL_action_l94c20 =
	     spi_writer$RDY_write && start_wire$whas &&
	     (state_mkFSMstate == 3'd0 || state_mkFSMstate == 3'd3) ;

  // rule RL_action_l95c20
  assign WILL_FIRE_RL_action_l95c20 =
	     spi_writer$RDY_write && state_mkFSMstate == 3'd1 ;

  // rule RL_action_l96c20
  assign WILL_FIRE_RL_action_l96c20 =
  ...
  assign state_set_pw$whas =
	     WILL_FIRE_RL_idle_l93c7 || WILL_FIRE_RL_action_l96c20 ||
	     WILL_FIRE_RL_action_l95c20 ||
  ...
  // register state_mkFSMstate
  always@(WILL_FIRE_RL_idle_l93c7 or
	  WILL_FIRE_RL_action_l94c20 or
	  WILL_FIRE_RL_action_l95c20 or WILL_FIRE_RL_action_l96c20)
  begin
    case (1'b1) // synopsys parallel_case
      WILL_FIRE_RL_idle_l93c7: state_mkFSMstate$D_IN = 3'd0;
      WILL_FIRE_RL_action_l94c20: state_mkFSMstate$D_IN = 3'd1;
      WILL_FIRE_RL_action_l95c20: state_mkFSMstate$D_IN = 3'd2;
      WILL_FIRE_RL_action_l96c20: state_mkFSMstate$D_IN = 3'd3;
      default: state_mkFSMstate$D_IN = 3'b010 /* unspecified value */ ;
    endcase
  end
  assign state_mkFSMstate$EN =
	     WILL_FIRE_RL_idle_l93c7 || WILL_FIRE_RL_action_l94c20 ||
	     WILL_FIRE_RL_action_l95c20 ||
	     WILL_FIRE_RL_action_l96c20 ;

  // submodule spi_writer
  always@(WILL_FIRE_RL_action_l96c20 or
	  WILL_FIRE_RL_action_l95c20 or WILL_FIRE_RL_action_l94c20)
  begin
    case (1'b1) // synopsys parallel_case
      WILL_FIRE_RL_action_l96c20: spi_writer$write_data = 8'h0;
      WILL_FIRE_RL_action_l95c20: spi_writer$write_data = 8'h14;
      WILL_FIRE_RL_action_l94c20: spi_writer$write_data = 8'h65;
      default: spi_writer$write_data = 8'b10101010 /* unspecified value */ ;
    endcase
  end
  assign spi_writer$EN_write =
	     WILL_FIRE_RL_action_l96c20 || WILL_FIRE_RL_action_l95c20 ||
	     WILL_FIRE_RL_action_l94c20 ;
  ...
  begin
	...
	$finish(32'd0);
    if (RST_N != `BSV_RESET_VALUE)
      $display("spi = %d hook_write_data = %d ",
	       spi_writer$spi,
	       spi_writer$hook_write_data);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_action_l94c20 &&
	  (WILL_FIRE_RL_action_l95c20 || WILL_FIRE_RL_action_l96c20))
	$display("Error: \"hello.bsv\", line 94, column 20: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_action_l94c20] and\n  [RL_action_l95c20, RL_action_l96c20] ) fired in the same clock cycle.\n");
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_action_l95c20 && WILL_FIRE_RL_action_l96c20)
	$display("Error: \"hello.bsv\", line 95, column 20: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_action_l95c20] and\n  [RL_action_l96c20] ) fired in the same clock cycle.\n");
    if (RST_N != `BSV_RESET_VALUE)
