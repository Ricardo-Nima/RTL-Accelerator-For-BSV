...
int main(int argc, char *argv[])
{
  ...
  MODEL_mkTb* p_model = (MODEL_mkTb*)(model);
	p_model->mkTb_instance->print_changelists();
	p_model->mkTb_instance->INST_spi_writer.print_changelists();
	p_model->mkTb_instance->INST_spi_writer.INST_counter.print_changelists();
	p_model->mkTb_instance->generate_testbench(bk_now(sim), "tb$top");
	p_model->mkTb_instance->INST_spi_writer.generate_testbench(bk_now(sim), "tb$top.INST_spi_writer");
	p_model->mkTb_instance->INST_spi_writer.INST_counter.generate_testbench(bk_now(sim), "tb$top.INST_spi_writer.INST_counter");
  bk_shutdown(sim);
