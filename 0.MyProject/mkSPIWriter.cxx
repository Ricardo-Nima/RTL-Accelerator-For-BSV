...
void MOD_mkSPIWriter::init_symbols_0()
{
  ...
  init_symbol(&symbols[7u], "hook_reg_hook_write_data", SYM_MODULE, &INST_hook_reg_hook_write_data);
  init_symbol(&symbols[8u], "mosi", SYM_MODULE, &INST_mosi);
  init_symbol(&symbols[9u], "RL_get_all_variable", SYM_RULE);
  init_symbol(&symbols[10u], "RL_spiFsm_action_l50c13", SYM_RULE);
  init_symbol(&symbols[11u], "RL_spiFsm_action_l52c13", SYM_RULE);
  init_symbol(&symbols[12u], "RL_spiFsm_action_l56c13", SYM_RULE);
  init_symbol(&symbols[13u], "RL_spiFsm_action_l61c15", SYM_RULE);
  init_symbol(&symbols[14u], "RL_spiFsm_action_l62c13", SYM_RULE);
  init_symbol(&symbols[15u], "RL_spiFsm_action_l63c14", SYM_RULE);
  init_symbol(&symbols[16u], "RL_spiFsm_fsm_start", SYM_RULE);
  init_symbol(&symbols[17u], "RL_spiFsm_idle_l49c7", SYM_RULE);
  init_symbol(&symbols[18u], "RL_spiFsm_restart", SYM_RULE);
  init_symbol(&symbols[19u], "RL_spiFsm_start_reg__dreg_update", SYM_RULE);
  init_symbol(&symbols[20u], "RL_spiFsm_state_every", SYM_RULE);
  init_symbol(&symbols[21u], "RL_spiFsm_state_fired__dreg_update", SYM_RULE);
  init_symbol(&symbols[22u], "RL_spiFsm_state_handle_abort", SYM_RULE);
  init_symbol(&symbols[23u], "RL_test", SYM_RULE);
  init_symbol(&symbols[24u], "sck", SYM_MODULE, &INST_sck);
  init_symbol(&symbols[25u], "spiFsm_abort", SYM_MODULE, &INST_spiFsm_abort);
  init_symbol(&symbols[26u], "spiFsm_start_reg", SYM_MODULE, &INST_spiFsm_start_reg);
  init_symbol(&symbols[27u], "spiFsm_start_reg_1", SYM_MODULE, &INST_spiFsm_start_reg_1);
  init_symbol(&symbols[28u],
	      "spiFsm_start_reg_1__h15180",
	      SYM_DEF,
	      &DEF_spiFsm_start_reg_1__h15180,
	      1u);
  init_symbol(&symbols[29u], "spiFsm_start_reg_2", SYM_MODULE, &INST_spiFsm_start_reg_2);
  init_symbol(&symbols[30u], "spiFsm_start_reg__h17351", SYM_DEF, &DEF_spiFsm_start_reg__h17351, 1u);
  init_symbol(&symbols[31u], "spiFsm_start_wire", SYM_MODULE, &INST_spiFsm_start_wire);
  init_symbol(&symbols[32u], "spiFsm_state_can_overlap", SYM_MODULE, &INST_spiFsm_state_can_overlap);
  init_symbol(&symbols[33u], "spiFsm_state_fired", SYM_MODULE, &INST_spiFsm_state_fired);
  init_symbol(&symbols[34u], "spiFsm_state_fired_1", SYM_MODULE, &INST_spiFsm_state_fired_1);
  init_symbol(&symbols[35u],
	      "spiFsm_state_fired__h15182",
	      SYM_DEF,
	      &DEF_spiFsm_state_fired__h15182,
	      1u);
  init_symbol(&symbols[36u], "spiFsm_state_mkFSMstate", SYM_MODULE, &INST_spiFsm_state_mkFSMstate);
  init_symbol(&symbols[37u], "spiFsm_state_overlap_pw", SYM_MODULE, &INST_spiFsm_state_overlap_pw);
  init_symbol(&symbols[38u], "spiFsm_state_set_pw", SYM_MODULE, &INST_spiFsm_state_set_pw);
  init_symbol(&symbols[39u], "ss", SYM_MODULE, &INST_ss);
  init_symbol(&symbols[40u],
	      "WILL_FIRE_RL_spiFsm_action_l50c13",
	      SYM_DEF,
	      &DEF_WILL_FIRE_RL_spiFsm_action_l50c13,
	      1u);
  init_symbol(&symbols[41u],
	      "WILL_FIRE_RL_spiFsm_action_l52c13",
	      SYM_DEF,
	      &DEF_WILL_FIRE_RL_spiFsm_action_l52c13,
	      1u);
  init_symbol(&symbols[42u],
	      "WILL_FIRE_RL_spiFsm_action_l56c13",
	      SYM_DEF,
	      &DEF_WILL_FIRE_RL_spiFsm_action_l56c13,
	      1u);
  init_symbol(&symbols[43u],
	      "WILL_FIRE_RL_spiFsm_action_l61c15",
	      SYM_DEF,
	      &DEF_WILL_FIRE_RL_spiFsm_action_l61c15,
	      1u);
  init_symbol(&symbols[44u],
	      "WILL_FIRE_RL_spiFsm_action_l62c13",
	      SYM_DEF,
	      &DEF_WILL_FIRE_RL_spiFsm_action_l62c13,
	      1u);
  init_symbol(&symbols[45u],
	      "WILL_FIRE_RL_spiFsm_action_l63c14",
	      SYM_DEF,
	      &DEF_WILL_FIRE_RL_spiFsm_action_l63c14,
	      1u);
  init_symbol(&symbols[46u], "wdata", SYM_MODULE, &INST_wdata);
  init_symbol(&symbols[47u], "x__h16080", SYM_DEF, &DEF_x__h16080, 32u);
}
...
void MOD_mkSPIWriter::RL_spiFsm_state_every()
{
  ...
  tUInt8 DEF_spiFsm_state_can_overlap__h2693;
  DEF_spiFsm_state_can_overlap__h2693 = INST_spiFsm_state_can_overlap.METH_read();
  DEF_spiFsm_state_set_pw_whas__6_OR_NOT_spiFsm_stat_ETC___d21 = INST_spiFsm_state_set_pw.METH_whas() || (!INST_spiFsm_state_overlap_pw.METH_whas() && DEF_spiFsm_state_can_overlap__h2693);
...
void MOD_mkSPIWriter::RL_spiFsm_action_l50c13()
{
...
void MOD_mkSPIWriter::RL_spiFsm_action_l52c13()
{
  tUInt8 DEF_x__h16044;
  tUInt8 DEF_cnt_7_BITS_2_TO_0___d46;
  tUInt8 DEF_bs__h16050;
  DEF_x__h16080 = INST_cnt.METH_read();
  DEF_bs__h16050 = INST_wdata.METH_read();
  DEF_cnt_7_BITS_2_TO_0___d46 = (tUInt8)((tUInt8)7u & DEF_x__h16080);
  DEF_x__h16044 = primExtract8(1u,
			       8u,
			       (tUInt8)(DEF_bs__h16050),
			       3u,
			       (tUInt8)(DEF_cnt_7_BITS_2_TO_0___d46),
  ...
  INST_mosi.METH_write(DEF_x__h16044);
}

void MOD_mkSPIWriter::RL_spiFsm_action_l56c13()
{
  tUInt32 DEF_cnt_7_MINUS_1___d50;
  DEF_x__h16080 = INST_cnt.METH_read();
  DEF_cnt_7_MINUS_1___d50 = DEF_x__h16080 - 1u;
...
void MOD_mkSPIWriter::RL_spiFsm_action_l61c15()
{
...
void MOD_mkSPIWriter::RL_spiFsm_action_l62c13()
{
...
void MOD_mkSPIWriter::RL_spiFsm_action_l63c14()
{
...
void MOD_mkSPIWriter::RL_spiFsm_idle_l49c7()
{
  INST_spiFsm_state_mkFSMstate.METH_write((tUInt8)0u);
  INST_spiFsm_state_fired_1.METH_wset((tUInt8)1u);
  INST_spiFsm_state_set_pw.METH_wset();
...
void MOD_mkSPIWriter::RL_get_all_variable()
{
	...
	if (inchange_write_data.size() == 0 || tempval_write_data != inchange_write_data.back().val) {
	...
	if (outchange_counter_count.size() == 0 || tempval_counter_count != outchange_counter_count.back().val) {
	...
	if (outchange_counter_overflow.size() == 0 || tempval_counter_overflow != outchange_counter_overflow.back().val) {
		outchange_counter_overflow.emplace_back(cur_time, tempval_counter_overflow);
	}
}

void MOD_mkSPIWriter::RL_test()
{
  DEF_b__h17421 = INST_counter.METH_count();
  DEF_unsigned_counter_count__3___d64 = DEF_b__h17421;
  DEF_counter_overflow____d65 = INST_counter.METH_overflow();
  if (!(PORT_RST_N == (tUInt8)0u))
  {
    dollar_display(sim_hdl,
		   ...
		   "s,4,1",
		   &__str_literal_2,
		   DEF_unsigned_counter_count__3___d64,
		   DEF_counter_overflow____d65);
    if (DEF_counter_overflow____d65)
...
{
  if (!(PORT_RST_N == (tUInt8)0u))
    if (DEF_WILL_FIRE_RL_spiFsm_action_l50c13 && ((((DEF_WILL_FIRE_RL_spiFsm_action_l52c13 || DEF_WILL_FIRE_RL_spiFsm_action_l56c13) || DEF_WILL_FIRE_RL_spiFsm_action_l61c15) || DEF_WILL_FIRE_RL_spiFsm_action_l62c13) || DEF_WILL_FIRE_RL_spiFsm_action_l63c14))
...
{
  if (!(PORT_RST_N == (tUInt8)0u))
    if (DEF_WILL_FIRE_RL_spiFsm_action_l52c13 && (((DEF_WILL_FIRE_RL_spiFsm_action_l56c13 || DEF_WILL_FIRE_RL_spiFsm_action_l61c15) || DEF_WILL_FIRE_RL_spiFsm_action_l62c13) || DEF_WILL_FIRE_RL_spiFsm_action_l63c14))
...
{
  if (!(PORT_RST_N == (tUInt8)0u))
    if (DEF_WILL_FIRE_RL_spiFsm_action_l56c13 && ((DEF_WILL_FIRE_RL_spiFsm_action_l61c15 || DEF_WILL_FIRE_RL_spiFsm_action_l62c13) || DEF_WILL_FIRE_RL_spiFsm_action_l63c14))
...
{
  if (!(PORT_RST_N == (tUInt8)0u))
    if (DEF_WILL_FIRE_RL_spiFsm_action_l61c15 && (DEF_WILL_FIRE_RL_spiFsm_action_l62c13 || DEF_WILL_FIRE_RL_spiFsm_action_l63c14))
...
{
  if (!(PORT_RST_N == (tUInt8)0u))
    if (DEF_WILL_FIRE_RL_spiFsm_action_l62c13 && DEF_WILL_FIRE_RL_spiFsm_action_l63c14)
...
{
  tUInt8 DEF_x__h17535;
  DEF_x__h17535 = (tUInt8)255u & (ARG_write_data + (tUInt8)13u);
  INST_hook_reg_hook_write_data.METH_write(ARG_write_data);
  INST_wdata.METH_write(DEF_x__h17535);
...
tUInt8 MOD_mkSPIWriter::METH_RDY_write()
{
  ...
  DEF_spiFsm_state_fired__h15182 = INST_spiFsm_state_fired.METH_read();
  DEF_spiFsm_abort_whas____d4 = INST_spiFsm_abort.METH_whas();
  DEF_spiFsm_abort_wget____d5 = INST_spiFsm_abort.METH_wget();
  DEF_spiFsm_start_reg_1__h15180 = INST_spiFsm_start_reg_1.METH_read();
  DEF_spiFsm_start_reg__h17351 = INST_spiFsm_start_reg.METH_read();
  ...
  DEF_spiFsm_abort_whas_AND_spiFsm_abort_wget_OR_spi_ETC___d60 = DEF_spiFsm_abort_whas_AND_spiFsm_abort_wget_OR_spi_ETC___d35 && (!DEF_spiFsm_start_reg_1__h15180 || DEF_spiFsm_state_fired__h15182);
  DEF_CAN_FIRE_write = DEF_spiFsm_abort_whas_AND_spiFsm_abort_wget_OR_spi_ETC___d60 && !DEF_spiFsm_start_reg__h17351;
...
{
  tUInt8 DEF__read__h85;
  tUInt8 DEF__read__h116;
  tUInt8 DEF__read__h147;
  tUInt8 PORT_spi;
  DEF__read__h147 = INST_mosi.METH_read();
  DEF__read__h116 = INST_sck.METH_read();
  DEF__read__h85 = INST_ss.METH_read();
  PORT_spi = (tUInt8)7u & (((DEF__read__h85 << 2u) | (DEF__read__h116 << 1u)) | DEF__read__h147);
  return PORT_spi;
}
...
unsigned int MOD_mkSPIWriter::dump_VCD_defs(unsigned int levels)
{
  ...
  vcd_write_def(sim_hdl, num++, "WILL_FIRE_RL_spiFsm_action_l50c13", 1u);
  vcd_set_clock(sim_hdl, num, __clk_handle_0);
  vcd_write_def(sim_hdl, num++, "WILL_FIRE_RL_spiFsm_action_l52c13", 1u);
  vcd_set_clock(sim_hdl, num, __clk_handle_0);
  vcd_write_def(sim_hdl, num++, "WILL_FIRE_RL_spiFsm_action_l56c13", 1u);
  vcd_set_clock(sim_hdl, num, __clk_handle_0);
  vcd_write_def(sim_hdl, num++, "WILL_FIRE_RL_spiFsm_action_l61c15", 1u);
  vcd_set_clock(sim_hdl, num, __clk_handle_0);
  vcd_write_def(sim_hdl, num++, "WILL_FIRE_RL_spiFsm_action_l62c13", 1u);
  vcd_set_clock(sim_hdl, num, __clk_handle_0);
  vcd_write_def(sim_hdl, num++, "WILL_FIRE_RL_spiFsm_action_l63c14", 1u);
  vcd_set_clock(sim_hdl, num, __clk_handle_0);
  vcd_write_def(sim_hdl, num++, "b__h17421", 4u);
  vcd_set_clock(sim_hdl, num, __clk_handle_0);
  vcd_write_def(sim_hdl, num++, "counter_overflow____d65", 1u);
  vcd_set_clock(sim_hdl, num, __clk_handle_0);
  ...
  vcd_set_clock(sim_hdl, num, __clk_handle_0);
  vcd_write_def(sim_hdl, num++, "spiFsm_start_reg_1__h15180", 1u);
  vcd_set_clock(sim_hdl, num, __clk_handle_0);
  vcd_write_def(sim_hdl, num++, "spiFsm_start_reg__h17351", 1u);
  vcd_set_clock(sim_hdl, num, __clk_handle_0);
  vcd_write_def(sim_hdl, num++, "spiFsm_state_fired__h15182", 1u);
  vcd_set_clock(sim_hdl, num, __clk_handle_0);
  ...
  vcd_set_clock(sim_hdl, num, __clk_handle_0);
  vcd_write_def(sim_hdl, num++, "unsigned_counter_count__3___d64", 4u);
  vcd_set_clock(sim_hdl, num, __clk_handle_0);
  vcd_write_def(sim_hdl, num++, "x__h16080", 32u);
...
void MOD_mkSPIWriter::vcd_defs(tVCDDumpType dt, MOD_mkSPIWriter &backing)
{
  ...
  if (dt == VCD_DUMP_XS)
  {
	...
	backing.PORT_RST_N = PORT_RST_N;
      ...
      ++num;
      if ((backing.DEF_WILL_FIRE_RL_spiFsm_action_l50c13) != DEF_WILL_FIRE_RL_spiFsm_action_l50c13)
      {
	vcd_write_val(sim_hdl, num, DEF_WILL_FIRE_RL_spiFsm_action_l50c13, 1u);
	backing.DEF_WILL_FIRE_RL_spiFsm_action_l50c13 = DEF_WILL_FIRE_RL_spiFsm_action_l50c13;
      }
      ++num;
      if ((backing.DEF_WILL_FIRE_RL_spiFsm_action_l52c13) != DEF_WILL_FIRE_RL_spiFsm_action_l52c13)
      {
	vcd_write_val(sim_hdl, num, DEF_WILL_FIRE_RL_spiFsm_action_l52c13, 1u);
	backing.DEF_WILL_FIRE_RL_spiFsm_action_l52c13 = DEF_WILL_FIRE_RL_spiFsm_action_l52c13;
      }
      ++num;
      if ((backing.DEF_WILL_FIRE_RL_spiFsm_action_l56c13) != DEF_WILL_FIRE_RL_spiFsm_action_l56c13)
      {
	vcd_write_val(sim_hdl, num, DEF_WILL_FIRE_RL_spiFsm_action_l56c13, 1u);
	backing.DEF_WILL_FIRE_RL_spiFsm_action_l56c13 = DEF_WILL_FIRE_RL_spiFsm_action_l56c13;
      }
      ++num;
      if ((backing.DEF_WILL_FIRE_RL_spiFsm_action_l61c15) != DEF_WILL_FIRE_RL_spiFsm_action_l61c15)
      {
	vcd_write_val(sim_hdl, num, DEF_WILL_FIRE_RL_spiFsm_action_l61c15, 1u);
	backing.DEF_WILL_FIRE_RL_spiFsm_action_l61c15 = DEF_WILL_FIRE_RL_spiFsm_action_l61c15;
      }
      ++num;
      if ((backing.DEF_WILL_FIRE_RL_spiFsm_action_l62c13) != DEF_WILL_FIRE_RL_spiFsm_action_l62c13)
      {
	vcd_write_val(sim_hdl, num, DEF_WILL_FIRE_RL_spiFsm_action_l62c13, 1u);
	backing.DEF_WILL_FIRE_RL_spiFsm_action_l62c13 = DEF_WILL_FIRE_RL_spiFsm_action_l62c13;
      }
      ++num;
      if ((backing.DEF_WILL_FIRE_RL_spiFsm_action_l63c14) != DEF_WILL_FIRE_RL_spiFsm_action_l63c14)
      {
	vcd_write_val(sim_hdl, num, DEF_WILL_FIRE_RL_spiFsm_action_l63c14, 1u);
	backing.DEF_WILL_FIRE_RL_spiFsm_action_l63c14 = DEF_WILL_FIRE_RL_spiFsm_action_l63c14;
      }
      ++num;
      if ((backing.DEF_b__h17421) != DEF_b__h17421)
      {
	vcd_write_val(sim_hdl, num, DEF_b__h17421, 4u);
	backing.DEF_b__h17421 = DEF_b__h17421;
      }
      ++num;
      if ((backing.DEF_counter_overflow____d65) != DEF_counter_overflow____d65)
      {
	vcd_write_val(sim_hdl, num, DEF_counter_overflow____d65, 1u);
	backing.DEF_counter_overflow____d65 = DEF_counter_overflow____d65;
      }
      ++num;
	...
	backing.DEF_spiFsm_abort_whas____d4 = DEF_spiFsm_abort_whas____d4;
      ...
      ++num;
      if ((backing.DEF_spiFsm_start_reg_1__h15180) != DEF_spiFsm_start_reg_1__h15180)
      {
	vcd_write_val(sim_hdl, num, DEF_spiFsm_start_reg_1__h15180, 1u);
	backing.DEF_spiFsm_start_reg_1__h15180 = DEF_spiFsm_start_reg_1__h15180;
      }
      ++num;
      if ((backing.DEF_spiFsm_start_reg__h17351) != DEF_spiFsm_start_reg__h17351)
      {
	vcd_write_val(sim_hdl, num, DEF_spiFsm_start_reg__h17351, 1u);
	backing.DEF_spiFsm_start_reg__h17351 = DEF_spiFsm_start_reg__h17351;
      }
      ++num;
      if ((backing.DEF_spiFsm_state_fired__h15182) != DEF_spiFsm_state_fired__h15182)
      {
	vcd_write_val(sim_hdl, num, DEF_spiFsm_state_fired__h15182, 1u);
	backing.DEF_spiFsm_state_fired__h15182 = DEF_spiFsm_state_fired__h15182;
      }
      ++num;
	...
	backing.DEF_spiFsm_state_mkFSMstate_read____d31 = DEF_spiFsm_state_mkFSMstate_read____d31;
      ...
      ++num;
      if ((backing.DEF_unsigned_counter_count__3___d64) != DEF_unsigned_counter_count__3___d64)
      {
	vcd_write_val(sim_hdl, num, DEF_unsigned_counter_count__3___d64, 4u);
	backing.DEF_unsigned_counter_count__3___d64 = DEF_unsigned_counter_count__3___d64;
      }
      ++num;
      if ((backing.DEF_x__h16080) != DEF_x__h16080)
      {
	vcd_write_val(sim_hdl, num, DEF_x__h16080, 32u);
	backing.DEF_x__h16080 = DEF_x__h16080;
      }
      ++num;
    }
    else
...
void MOD_mkSPIWriter::vcd_submodules(tVCDDumpType dt, unsigned int levels, MOD_mkSPIWriter &backing)
{
