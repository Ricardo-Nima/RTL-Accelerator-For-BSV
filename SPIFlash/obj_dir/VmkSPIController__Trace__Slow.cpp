...
void VmkSPIController___024root__traceInitSub0(VmkSPIController___024root* vlSelf, VerilatedVcd* tracep) VL_ATTR_COLD;

void VmkSPIController___024root__traceInitTop(VmkSPIController___024root* vlSelf, VerilatedVcd* tracep) {
    if (false && vlSelf) {}  // Prevent unused
    VmkSPIController__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    // Body
    {
        VmkSPIController___024root__traceInitSub0(vlSelf, tracep);
    }
}

void VmkSPIController___024root__traceInitSub0(VmkSPIController___024root* vlSelf, VerilatedVcd* tracep) {
    if (false && vlSelf) {}  // Prevent unused
    VmkSPIController__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
...
void VmkSPIController___024root__traceFullTop0(void* voidSelf, VerilatedVcd* tracep) VL_ATTR_COLD;
void VmkSPIController___024root__traceChgTop0(void* voidSelf, VerilatedVcd* tracep);
void VmkSPIController___024root__traceCleanup(void* voidSelf, VerilatedVcd* /*unused*/);

void VmkSPIController___024root__traceRegister(VmkSPIController___024root* vlSelf, VerilatedVcd* tracep) {
    if (false && vlSelf) {}  // Prevent unused
    VmkSPIController__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    // Body
    {
        tracep->addFullCb(&VmkSPIController___024root__traceFullTop0, vlSelf);
        tracep->addChgCb(&VmkSPIController___024root__traceChgTop0, vlSelf);
        tracep->addCleanupCb(&VmkSPIController___024root__traceCleanup, vlSelf);
    }
}

void VmkSPIController___024root__traceFullSub0(VmkSPIController___024root* vlSelf, VerilatedVcd* tracep) VL_ATTR_COLD;

void VmkSPIController___024root__traceFullTop0(void* voidSelf, VerilatedVcd* tracep) {
    VmkSPIController___024root* const __restrict vlSelf = static_cast<VmkSPIController___024root*>(voidSelf);
    VmkSPIController__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    // Body
    {
        VmkSPIController___024root__traceFullSub0((&vlSymsp->TOP), tracep);
    }
}

void VmkSPIController___024root__traceFullSub0(VmkSPIController___024root* vlSelf, VerilatedVcd* tracep) {
    if (false && vlSelf) {}  // Prevent unused
    VmkSPIController__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
