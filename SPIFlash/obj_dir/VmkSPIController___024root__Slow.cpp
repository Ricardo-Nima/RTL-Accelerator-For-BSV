...
void VmkSPIController___024root___ctor_var_reset(VmkSPIController___024root* vlSelf);

VmkSPIController___024root::VmkSPIController___024root(const char* _vcname__)
    : VerilatedModule(_vcname__)
 {
    // Reset structure values
    VmkSPIController___024root___ctor_var_reset(this);
}

void VmkSPIController___024root::__Vconfigure(VmkSPIController__Syms* _vlSymsp, bool first) {
    if (false && first) {}  // Prevent unused
    this->vlSymsp = _vlSymsp;
}

VmkSPIController___024root::~VmkSPIController___024root() {
}

void VmkSPIController___024root___initial__TOP__3(VmkSPIController___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VmkSPIController__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VmkSPIController___024root___initial__TOP__3\n"); );
    // Variables
    ...
    mkTb__DOT__spiflash_ctrl__DOT__page_buffer_serverAdapterB_outDataCore__DOT__arr[0U] = 0xaaU;
    mkTb__DOT__spiflash_ctrl__DOT__page_buffer_serverAdapterB_outDataCore__DOT__arr[1U] = 0xaaU;
    ...
    mkTb__DOT__spiflash_ctrl__DOT__page_buffer_memory__DOT__i = 0U;
    while ((0x100U > mkTb__DOT__spiflash_ctrl__DOT__page_buffer_memory__DOT__i)) {
        vlSelf->mkTb__DOT__spiflash_ctrl__DOT__page_buffer_memory__DOT__RAM[(0xffU 
                                                                             & mkTb__DOT__spiflash_ctrl__DOT__page_buffer_memory__DOT__i)] = 0xaaU;
        mkTb__DOT__spiflash_ctrl__DOT__page_buffer_memory__DOT__i 
            = ((IData)(1U) + mkTb__DOT__spiflash_ctrl__DOT__page_buffer_memory__DOT__i);
    }
...
void VmkSPIController___024root___settle__TOP__4(VmkSPIController___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VmkSPIController__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VmkSPIController___024root___settle__TOP__4\n"); );
    // Variables
...
void VmkSPIController___024root___eval_initial(VmkSPIController___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VmkSPIController__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VmkSPIController___024root___eval_initial\n"); );
    // Body
    vlSelf->__Vclklast__TOP__CLK = vlSelf->CLK;
    VmkSPIController___024root___initial__TOP__3(vlSelf);
}

void VmkSPIController___024root___eval_settle(VmkSPIController___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VmkSPIController__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VmkSPIController___024root___eval_settle\n"); );
    // Body
    VmkSPIController___024root___settle__TOP__4(vlSelf);
}

void VmkSPIController___024root___final(VmkSPIController___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VmkSPIController__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VmkSPIController___024root___final\n"); );
}

void VmkSPIController___024root___ctor_var_reset(VmkSPIController___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VmkSPIController__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VmkSPIController___024root___ctor_var_reset\n"); );
    // Body
